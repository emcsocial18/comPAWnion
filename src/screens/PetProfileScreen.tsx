...
export default function PetProfileScreen({ navigation, route }: any){
  const { pet, savePet, premium, completeOnboarding } = useContext(AppContext);
  ...
  const calculateAge = (dateString: string, endDateString?: string) => {
  ...
  const onBirthDatePickerChange = (event: any, selectedDate?: Date) => {
  ...
  const onDatePassedPickerChange = (event: any, selectedDate?: Date) => {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <Text style={styles.sectionHeader}>📸 Upload Photo (Optional)</Text>
        <TouchableOpacity style={styles.photoUploadButton} onPress={pickImage}>
          {photo ? (
            ...
            <View style={styles.uploadPlaceholder}>
              ...
              <Text style={styles.uploadHint}>Tap here to select from gallery</Text>
            </View>
          )}
        </TouchableOpacity>
                ...
                <View style={styles.datePickerButtons}>
                  ...
                  <TouchableOpacity 
                    ...
                    onPress={() => {
                      ...
                      console.log('Done button pressed - formatted date:', formatted);
                      setBirthDate(formatted);
                      const endDate = (!isPawPal && datePassed) ? datePassed : undefined;
                      const calculatedAge = calculateAge(formatted, endDate);
                      console.log('Done button - calculated age:', calculatedAge);
                      if (calculatedAge) {
                        setAge(calculatedAge);
                      }
                      setShowBirthDatePicker(false);
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>Personality Traits (Optional)</Text>
          <TextInput
            style={[styles.input, styles.textArea]}
            placeholder="Playful, gentle, curious..."
            placeholderTextColor={colors.subtext}
            value={traits}
        ...
        <View style={styles.inputGroup}>
          <Text style={styles.label}>Habits & Favorites (Optional)</Text>
          <TextInput
            style={[styles.input, styles.textArea]}
            placeholder="Loved belly rubs, favorite toy..."
            placeholderTextColor={colors.subtext}
            value={habits}
